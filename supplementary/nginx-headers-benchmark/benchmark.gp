...
plot "data/1-nginx-sm-buffer-sm.csv" using 1:(resolveUnit(stringcolumn(2))) with lines title "client\\\_header\\\_buffer\\\_size=1k" linestyle 1, \
     "data/2-nginx-sm-buffer-lg.csv" using 1:(resolveUnit(stringcolumn(2))) with lines title "client\\\_header\\\_buffer\\\_size=10k" linestyle 2, \
     "data/3-nginx-sm-buffer-hg.csv" using 1:(resolveUnit(stringcolumn(2))) with lines title "client\\\_header\\\_buffer\\\_size=128k" linestyle 3

set output postdir."/nginx-memory-large-headers-light.svg"
set key center right

plot "data/4-nginx-sm-buffer-sm.csv" using 1:(resolveUnit(stringcolumn(2))) with lines title "client\\\_header\\\_buffer\\\_size=1k" linestyle 1, \
     "data/5-nginx-sm-buffer-lg.csv" using 1:(resolveUnit(stringcolumn(2))) with lines title "client\\\_header\\\_buffer\\\_size=10k" linestyle 2, \
     "data/6-nginx-sm-buffer-hg.csv" using 1:(resolveUnit(stringcolumn(2))) with lines title "client\\\_header\\\_buffer\\\_size=128k" linestyle 3

set output postdir."/nginx-memory-huge-headers-light.svg"
set key bottom right

plot "data/4-nginx-sm-buffer-sm.csv" using 1:(resolveUnit(stringcolumn(2))) with lines title "client\\\_header\\\_buffer\\\_size=1k" linestyle 1, \
     "data/7-nginx-lg-buffer.csv" using 1:(resolveUnit(stringcolumn(2))) with lines title "large\\\_client\\\_header\\\_buffers=4 16k" linestyle 2
